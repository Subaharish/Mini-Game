...
threeWayPipe.addEventListener('click',()=>{
    // threeWayPipe.classList.add('rotate')
    // threeWayPipe.classList.remove('rotate')
    // threeWayPipe.style.transform = 'rotate(90deg)'
    ...
    // threeWayPipe.style.top = '5px'
    // console.log(threeWayPipe)

})
twoWayPipe.addEventListener('click',()=>{
    // twoWayPipe.classList.add('rotate')
    // threeWayPipe.classList.remove('rotate')
    // twoWayPipe.style.transform = 'rotate(90deg)'
    rotatetwo(twoWayPipe);
    twoWayPipe.style.left = '12px'
    console.log('click')
...
function manageGlow(ele){
    ...
    // console.log(`Rotate:${angle +90 }deg`);
    if (rotateValue === 90 && count === 3){
        threeWayPipe.style.top = '4px'
        threeWayPipe.style.left = '10px'
